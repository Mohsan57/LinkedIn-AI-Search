...
class QdrantSearch:
    def __init__(self, resumes, jd):
        ...
        self.openai = OpenAI(api_key="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")
        self.collection_name = "Test-Cluster"
    ...
    def get_embedding(self, text):
        ...
        try:
            ...
            return list(map(float, embeddings.data[0].embedding)), len(embeddings.data[0].embedding)
        except Exception as e:
    ...
    def search(self):
        ...
        hits = self.qdrant.search(
            collection_name=self.collection_name, query_vector=vector, limit=30, timeout=1000
        )
        results = []
        for hit in hits:
...
if __name__ == "__main__":
    ...
    job_dict = read_config(
        ...
        + "/JobDescription-job_desc_java_developer.pdf1fb6435c-531a-4f04-84c2-c4e73e1f1a3f.json"
    )
